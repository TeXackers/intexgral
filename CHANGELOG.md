...
### Fixed
- Issue with `defaultvar` ([issue #20](https://github.com/TeXackers/intexgral/issues/20)).
...
### Fixed
- Issue with `\differentials` used in `product` mode ([issue #14](https://github.com/TeXackers/intexgral/issues/14)).
- Issue with `\RenewSymbolKeyword` and `\DeclareSymbolKeyword` ([issue #15](https://github.com/TeXackers/intexgral/issues/15)).
- Issue with `\RenewVariableKeyword` and `\DeclareVariableKeyword` ([issue #17](https://github.com/TeXackers/intexgral/issues/17)).
